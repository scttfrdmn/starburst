...
<!-- badges: start -->
[![R-CMD-check](https://github.com/yourusername/starburst/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/yourusername/starburst/actions/workflows/R-CMD-check.yaml)
[![Codecov test coverage](https://codecov.io/gh/yourusername/starburst/branch/main/graph/badge.svg)](https://app.codecov.io/gh/yourusername/starburst?branch=main)
...
```{r}
# Install from GitHub
remotes::install_github("yourusername/starburst")
...
- [Getting Started](https://yourusername.github.io/starburst/articles/getting-started.html)
- [Architecture](ARCHITECTURE.md)
- [Roadmap](ROADMAP.md)
- [Examples](https://yourusername.github.io/starburst/articles/examples.html)
...
@software{starburst,
  ...
  year = {2026},
  url = {https://github.com/yourusername/starburst}
}
```
