...
- **Smart Quota Management**: Automatically splits work into sequential batches when hitting AWS quota limits, with automatic quota increase requests
...
3. **Task Submission**: Launches Fargate tasks (or sequential batches if quota-limited)
