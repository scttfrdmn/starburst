...
vignette: >
  %\VignetteIndexEntry{Detached Session Mode}
...
✅ **Good use cases:**
- Long-running analyses (hours to days)
- Computations you want to monitor remotely
- Jobs that might exceed your local R session lifetime
- Analyses you want to inspect partially before completion

❌ **Not ideal for:**
- Quick computations (< 5 minutes)
- Interactive workflows requiring immediate feedback
- Tasks with millisecond-level coordination requirements
...
- `?starburst_session` - Create detached session
- `?starburst_session_attach` - Reattach to session
